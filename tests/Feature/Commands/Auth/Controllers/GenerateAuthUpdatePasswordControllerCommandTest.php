...
class GenerateAuthUpdatePasswordControllerCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_can_generate_auth_update_password_controller_file(): void
    {
        ...
        $this->artisan('generate:auth_update_password_controller', ['table' => 'customers', '--create' => true])
             ->assertSuccessful();
    }
}
